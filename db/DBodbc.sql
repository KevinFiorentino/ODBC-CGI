...
INSERT INTO `dbodbc`.`Localidad` (`idLocalidad`, `localidad`) VALUES (4, 'Temperley');
INSERT INTO `dbodbc`.`Localidad` (`idLocalidad`, `localidad`) VALUES (5, 'Avellaneda');
INSERT INTO `dbodbc`.`Localidad` (`idLocalidad`, `localidad`) VALUES (6, 'Berazategui');
INSERT INTO `dbodbc`.`Localidad` (`idLocalidad`, `localidad`) VALUES (7, 'Quilmes');
INSERT INTO `dbodbc`.`Localidad` (`idLocalidad`, `localidad`) VALUES (8, 'Florencio Varela');
INSERT INTO `dbodbc`.`Localidad` (`idLocalidad`, `localidad`) VALUES (9, 'Barracas');
...
START TRANSACTION;
USE `dbodbc`;
INSERT INTO `dbodbc`.`Filial` (`idFilial`, `horarioDesde`, `horarioHasta`, `diaMantenimiento`, `idLocalidad`) VALUES (1, NULL, NULL, NULL, 1);
INSERT INTO `dbodbc`.`Filial` (`idFilial`, `horarioDesde`, `horarioHasta`, `diaMantenimiento`, `idLocalidad`) VALUES (2, NULL, NULL, NULL, 2);
INSERT INTO `dbodbc`.`Filial` (`idFilial`, `horarioDesde`, `horarioHasta`, `diaMantenimiento`, `idLocalidad`) VALUES (3, NULL, NULL, NULL, 3);
...
INSERT INTO `dbodbc`.`Cancha` (`idCancha`, `idTipoCancha`, `idFilial`) VALUES (NULL, 4, 3);
