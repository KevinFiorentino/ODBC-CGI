...
<body>
	...
	<h3>Solicitud de Turno para la Cancha</h3>
	<h6>Recomendaci&oacute;n: No se registrar&aacute;n reservas con menos de una hora de anticipaci&oacute;n</h6>
	
	<div>
	  <?= form_open('Reservas/VerificarTurno') ?>
	  	  <input type="hidden" name="filial" value="<?php echo $_GET['filial'] ?>" >
	  	  <input type="hidden" name="cancha" value="<?php echo $_GET['cancha'] ?>" >
